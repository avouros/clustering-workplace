function [x,y,lb1,lb2] = brodinova(varargin)
%DAYASYNTH. This function generates synthetic datasets with informative
%and uninformative features and outliers.

% Authors:
% Original function written in R by Sarka Brodinova (R package: wrsk)
% <sarka.brodinova@tuwien.ac.at>
% MATLAB version written by Avgoustinos Vouros

% References:
% [1] Brodinová, Šárka, et al. "Robust and sparse k-means clustering for 
